...
## 2026-09-01 JPEG/H264覆盖

本页后续“JPEG-only/拒绝H264”的文字是2026-08-31历史实现，已被新版本覆盖。当前setting为0不修改、1 H264、2 JPEG，发布format分别为3/2；新增原生RTSP H264 copy-only路径、Annex-B access-unit解析、ONVIF GOP/码率应用、相机专用重启及fd隔离。JPEG1000帧9.939858Hz，H264三分钟1800帧10.010749Hz，两格式整板重启持久化通过。完整文件、SHA、切换与解码证据见[相机双格式交付记录](CAMERA_DUAL_FORMAT_20260901.md)。当前最终运行JPEG。
